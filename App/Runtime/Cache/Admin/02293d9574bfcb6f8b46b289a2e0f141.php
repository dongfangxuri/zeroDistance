...
<div class="page-container">
	<form action='/Admin/Index/menu_add.html' method='post' class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-2">
				<input type="file" class="input-text" name='image_url'>
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>排序id：</label>
            <div class="formControls col-xs-4 col-sm-2">
