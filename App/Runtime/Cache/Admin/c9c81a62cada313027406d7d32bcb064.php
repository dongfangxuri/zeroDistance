...
<div class="page-container">
	<!-- <div class="text-c"> 
        <form method="post" action="/Admin/Meal/mealtime_list/id/3">
	...
	<a class="btn btn-primary radius" data-title="添加活动套餐时间" _href="/Admin/Meal/mealtime_add/me_id/<?php echo ($me_id); ?>" onclick="Hui_admin_tab(this)" href="javascript:;">
	<i class="Hui-iconfont">&#xe600;</i> 添加活动套餐时间</a>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="text-c">
					...
					<!-- <a style="text-decoration:none" class="ml-5" onClick="article_edit('套餐编辑','/Admin/Meal/mealtime_update/id/<?php echo ($vo["id"]); ?>','<?php echo ($vo["id"]); ?>')" href="javascript:;" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a>  -->
					<a style="text-decoration:none" class="ml-5" href="/Admin/Meal/mealprice_list/id/<?php echo ($vo["id"]); ?>" title="设置套餐价格"><i class="Hui-iconfont">&#xe615;</i></a>
					<a style="text-decoration:none" class="ml-5"  href="/Admin/Meal/mealtime_delete/id/<?php echo ($vo["id"]); ?>" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
