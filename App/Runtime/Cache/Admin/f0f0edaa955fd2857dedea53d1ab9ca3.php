...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="<?php echo U('Login/index');?>" method="post">
      <div class="row cl">
      ...
      <!-- <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img id='veri' src="<?php echo U('verify');?>"> <!-- <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>  -->
      <!--   </div> -->
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
...
<div class="footer">Copyright  零距离童军 河南微系网络科技有限公司</div>
