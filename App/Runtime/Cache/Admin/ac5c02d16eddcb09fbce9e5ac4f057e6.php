...
<article class="page-container">
	<form action='/Admin/Meal/mealprice_update/id/3' method='post' class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">						
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">套餐类型：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
				<select class="select" name="type_id">
					<?php if(is_array($list)): foreach($list as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; ?>
				</select>
				</span> 
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">套餐价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
			    <input type="text" class="input-text" value="<?php echo ($model["price"]); ?>" placeholder="" id="" name="price">
			</div>
		</div>
		<div class="row cl">
