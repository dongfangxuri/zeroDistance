...
<div class="page-container">
	<div class="text-c">
	 <form action="/Admin/Index/menu_list" method="post">
		<input type="text" name="menu_name" id="" placeholder=" 菜单名称" style="width:250px" class="input-text">
		<button name="" id="" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜菜单</button>
	 </form>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	 <span class="l"> <!-- <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> -->
	  <a class="btn btn-primary radius" data-title="添加菜单" _href="<?php echo U('/Admin/Index/menu_add');?>" onclick="Hui_admin_tab(this)" href="javascript:;">
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="text-c">
					...
					<td><img width="100" class="picture-thumb" src="/<?php echo ($vo["image_url"]); ?>"></td>
					<td class="td-manage">
					<!-- <a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="下架"> 
					<i class="Hui-iconfont">&#xe6de;</i></a>-->
					<a style="text-decoration:none" class="ml-5" onClick="picture_edit('菜单编辑','/Admin/Index/menu_update/id/<?php echo ($vo["id"]); ?>','<?php echo ($vo["id"]); ?>')" href="javascript:;" title="编辑">
					<i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="return confirm('确认删除此项菜单吗?');" href="/Admin/Index/menu_del/id/<?php echo ($vo["id"]); ?>" title="删除">
