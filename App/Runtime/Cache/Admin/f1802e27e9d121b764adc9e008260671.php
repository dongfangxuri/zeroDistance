...
<title>添加活动 - 活动管理 - 零距离童军</title>
<meta name="keywords" content="零距离童军">
<meta name="description" content="零距离童军">
</head>
<body>
<article class="page-container">
	<form action='/Admin/Active/active_add.html' method='post' class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="ac_title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">活动标签：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="lable">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">活动景区：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="view_addr">
			</div>
		</div>
			...
			<div class="formControls col-xs-8 col-sm-9">
			  <span class="select-box">
				<select class="select" name="is_top">
					<option value="1" select="selected">置顶</option>
		...
		<div class="row cl" id="half" style="display:none;">
			...
			<div class="formControls col-xs-2 col-sm-2">
				...
				&nbsp;&nbsp;<span>报名人数</span>
				<input type="text" class="input-text" value="0" placeholder="" id="" name="morning_partake_num">
			</div>
			...
			<div class="formControls col-xs-2 col-sm-2">
				...
				&nbsp;&nbsp;<span>报名人数</span>
				<input type="text" class="input-text" value="0" placeholder="" id="" name="after_partake_num">
			</div>
			<span>时间格式：09:00-12:00</span>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">添加自由编辑行：</label>
			<div class="formControls col-xs-8 col-sm-9">
			  <span class="select-box">
				<select class="select" id="content" name="add_content" onchange="Changecontent();">
					<option value="0" select="selected">否</option>
					<option value="1" >是</option>
				</select>
			  </span> 
		...
		<div id="freecontent" style="display:none;">
		    <div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">自由编辑内容：</label>
				<div class="formControls col-xs-6 col-sm-7">
					<input type="text" class="input-text" value="" placeholder="" name="content1">
				</div>
				<input type="button" id="continueadd" value="继续添加"/>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="sort_id">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="fit_age">
			</div>
		</div>
		<!-- <div class="row cl">
		  	<label class="form-label col-xs-4 col-sm-2">价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="single_price">
			</div>
		</div>
         -->
		...
		<div class="row cl">
			...
			<!-- <span>如果此项活动在多个城市开通，请在各个城市间以逗号分割</span> -->
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片上传：</label>
			<div class="formControls col-xs-4 col-sm-5">
				<input type="file" class="input-text" name='ac_img'>
			</div>
			<span>图片大小最好为750*470大小，过大或过小都会造成图片显示的失真</span>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">活动简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="ac_intro" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<script id="editor" type="text/plain" name="ac_content" style="width:100%;height:400px;"></script>
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
			    <input type="hidden" name="freecontent" id="freecontent1" value=""/>
...
<script >
<!--添加出行人-->
$('#continueadd').on("click",function(e){
    ...
    var html='<div class="row cl">'+
            '<label class="form-label col-xs-4 col-sm-2">自由编辑内容：</label>'+
                '<div class="formControls col-xs-6 col-sm-7">'+
                   '<input type="text" class="input-text" value="" placeholder="自由编辑内容" name="content'+num+'" >'+
                '</div>'+
             '</div>';
    //新添加的dom没有执行上边调用插件的代码；
    $(html).appendTo("#freecontent");
    //init();
});

/*function Read()
{
	var freecontent=$("#freecontent1").val();//自由编辑行内容
	var content=$(".content1").val();//自由编辑行内容
	freecontent+="-";
	freecontent+=content;
	$("#freecontent1").val(freecontent);
}*/
</script>
<script>
