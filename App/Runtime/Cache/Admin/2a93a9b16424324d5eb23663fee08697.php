...
<title>新增文章 - 资讯管理 - 亲子</title>
<meta name="keywords" content="亲子">
<meta name="description" content="亲子">
</head>
<body>
<article class="page-container">
	<form action='/Admin/Meal/meal_type_add' method='post' class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		  <div style="text-align:center;margin-top:50px;margin-bottom:50px;">
		  <span>套餐类别：</span>
				<select  name="type_parent">
					<option value="0" select="selected">0</option>
