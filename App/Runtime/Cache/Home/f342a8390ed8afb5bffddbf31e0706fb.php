   ...
   <!--  <div id="alert_content" class="layout">
    ...
    <div class="layout">
        <div  class="line text-center padding " style="background: #FC9A03">
            ...
            <div class="x11 ">
                <h1 class="text-white">待评价订单</h1>
            </div>
        </div>
     <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="line bg-white padding pjList">
            <dl class="clearfix">
                <dd class="x3"><a href="/Home/Index/detail/ac_id/<?php echo ($vo["ac_id"]); ?>"><img src="/<?php echo ($vo["pic"]); ?>" alt="" class="img-responsive"></a></dd>
                <dt class="x9">
                    <p class="text-more margin-big-left">
                        <a href="#" class="margin-small-left"><?php echo ($vo["ac_title"]); ?>
                        </a>
                    </p>
                <p class="margin-big-left sj">
            ...
            <div >
                <a style="font-size:2rem" onclick="return confirm('订单删除后无法恢复，确定要取消此次报名吗？');" href="/Home/Min/cancle_order/orderid/<?php echo ($vo["oid"]); ?>" class="x6  border text-center padding-big del" >删除订单</a> 
                <a style="font-size:2rem" href="/Home/Min/evalute/orderid/<?php echo ($vo["oid"]); ?>" class="x6 text-red  border  text-center padding-big pj" >去评价</a>
            </div>
